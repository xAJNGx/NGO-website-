        ...
        <!-- End of Page Heading -->
            ...
            <!-- Footer -->
                <footer id="footer">
                    ...
                    <i class="foot fas fa-phone-alt" onclick="copyToClipboard('9222222222'),alert('contact info copied to clipboard')"></i>
                    <p class="p-foot">© Copyright 2020 Kopila Nepal NGO</p>
                </footer>
                <!-- End of Footer -->
    <!-- JS Scripts -->
    <script type="text/javascript" src="project.js"></script> 
